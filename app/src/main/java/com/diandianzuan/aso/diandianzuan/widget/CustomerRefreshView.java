package com.diandianzuan.aso.diandianzuan.widget;
...
public class CustomerRefreshView extends FrameLayout implements IHeaderView {

    private ImageView refreshArrow;
    private ImageView loadingView;
    private TextView refreshTextView;

    public CustomerRefreshView(Context context) {
        this(context, null);
    }

    public CustomerRefreshView(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public CustomerRefreshView(Context context, AttributeSet attrs, int defStyleAttr) {
        super(context, attrs, defStyleAttr);
        init();
    }

    private void init() {
        View rootView = View.inflate(getContext(), R.layout.view_load_uumi, null);
