package com.diandianzuan.aso.diandianzuan.adapter.expand;
...
public abstract class CommonExpandableListAdapter<T, K> extends BaseExpandableListAdapter {
    protected abstract void getChildView(ViewHolder holder, int groupPosition, int childPosition, boolean isLastChild, T data);

    protected abstract void getGroupView(ViewHolder holder, int groupPosition, boolean isExpanded, K data);
    ...
    public CommonExpandableListAdapter(Context context, int childResource, int groupResource, List<List<T>> childrenData, List<K> groupData) {
